...
class Scrollbar {
    ...
    static createScroll(_, y, offsetHeight, offsetTop, height, top, scrollHeight, scrollTop, clientY, offsetY, maxY, spaceY){
        let oh, sh, th, start = 0, end = 0, cur = 0, prev = 0, result = 0, dir = 0, prevent = {passive: false};
        ...
        function startFn(e) {
            ...
            document.body.classList.add('scroll-unselect');
        ...
        function endFn(){
            ...
            document.body.classList.remove('scroll-unselect');
        }
