export default {
  data: {
    ...
    career: [{
      ...
      job: '景观设计师',
      harvest: `只有两三个人的小公司，身兼多职，所以一般一个项目从测量、绘制CAD、建模、效果、报价预算、施工图绘制、竣工决算等全程都做。
      这期间，CAD、3Dmax、Sketchup能力发生了质的飞跃，同时学了vary渲染、lumion室外景观场景动画两个新的。
      经过这么一磨，领悟到了一个深刻的问题：不适合做景观，而更适合做技术这种不需要忽悠也不需要说太多话的行业。`
    }, {
      date: '2016年3月',
      company: '香港文汇网',
      job: '前端开发工程师',
      harvest: `2015年底因为朋友创业想让我帮做网站，开始自学代码，发现自己非常擅长而且已经喜欢上代码无法自拔。
      于是2015年12月离职在家自学代码三个月不出门。从html5、css3、js到php、mysql，做了两个案例，并把前端到后台的数据来龙去脉都搞通了。
      2016年3月收到香港文汇网的面试邀请，经三轮面试后，在香港文汇网新媒体中心入职前端工程师，正式加入前端行业。
      工作近三年，除了完全通透面向对象编程以及性能等高级操作外，还学了nodejs、nwjs、java、ffmpeg、c++等新知识。
      写前端页面已经毫无挑战性，写框架、写游戏，不学框架，但能用任意框架，才是体现真正的能力。`
    }, {
      date: '2018年9月',
      company: '期待',
      job: '大前端或全栈或全能',
      harvest: '我希望争取一份荣耀，而不止是待遇。'
    }]
  }
}
